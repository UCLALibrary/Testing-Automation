...
class TestController extends Controller {
    ...
    /**
     * Display categories of each test.
     *
     * @param  int  $id
     * @return Response
     */
    ...
    /**
     * Leave comment for a test. (not in use)
     *
     * @param  int       $id
     * @param  Request   $request
     * @return Response
