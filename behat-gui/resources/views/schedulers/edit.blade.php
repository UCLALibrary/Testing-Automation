        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('schedulers.update', $scheduler->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('command')) has-error @endif">
                    ...
                    <input type="text" id="command-field" name="command" class="form-control" value="{{ $scheduler->command }}"/>
                    ...
                    <input type="text" id="parameters-field" name="parameters" class="form-control" value="{{ $scheduler->parameters }}"/>
                    ...
                    <input type="text" id="frequency-field" name="frequency" class="form-control" value="{{ $scheduler->frequency }}"/>
