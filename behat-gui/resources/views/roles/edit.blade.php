        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="display_name-field" name="display_name" class="form-control" value="{{ $role->display_name }}"/>
                    ...
                    <input type="text" id="description-field" name="description" class="form-control" value="{{ $role->description }}"/>
