        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('header')) has-error @endif">
                    ...
                    <input type="text" id="header-field" name="header" class="form-control" value="{{ $category->header }}"/>
                    ...
                    <input type="text" id="value-field" name="value" class="form-control" value="{{ $category->value }}"/>
                       @if($errors->has("value"))
