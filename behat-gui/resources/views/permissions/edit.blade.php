...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Permissions / Edit #{{$permission->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('permissions.update', $permission->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="display_name-field" name="display_name" class="form-control" value="{{ $permission->display_name }}"/>
                    ...
                    <input type="text" id="description-field" name="description" class="form-control" value="{{ $permission->description }}"/>
