        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('variables.update', $variable->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('key')) has-error @endif">
                    ...
                    <input type="text" id="key-field" name="key" class="form-control" value="{{ $variable->key }}"/>
                       @if($errors->has("key"))
                    ...
                    <input type="text" id="value-field" name="value" class="form-control" value="{{ $variable->value }}"/>
                       @if($errors->has("value"))
